...
namespace EgitimPortali.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, EducationRepository educationRepository, IMapper mapper, UserRepository userRepository, IConfiguration config, INotyfService notyf, IFileProvider fileProvider)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            educations = educations.Where(s => s.IsActive == true).ToList();
